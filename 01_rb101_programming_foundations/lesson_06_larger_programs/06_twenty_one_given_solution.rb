...
#   # Correct for aces
#   ace_count.times { points -= 10 if points > BUST_THRESHOLD }
#   points
# end
...
#       prompt "You have entered an invalid response ..."
#     end
#     break if answer == 'stay' || answer == 's' || busted?(cards)
#     hit(cards)
