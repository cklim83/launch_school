...
Setter methods are created similarly to getter methods. Manually,
they look the same except with an added = in the name and a parameter:
...
If we invoke #greet on kitty, we'll see that change take effect:
