...
"largest" when we call max on sides. So, to check for this, we make sure
that the total sum of the side lengths is greater than 2 times the largest
side. Another way to express this would be:
