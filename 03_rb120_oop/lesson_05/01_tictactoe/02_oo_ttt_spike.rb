...
class Board
  ...
  def count_human_marker(squares)
    squares.collect(&:marker).count(TTTGame::HUMAN_MARKER) # Array.map { |elem| elem.marker }.count(TTTGame::HUMAN_MARKER)
  end
...
class TTTGame
  ...
  def display_board(clear=true)
    ...
    puts "Human is a #{human.marker}. Computer is a #{computer.marker}."
    puts ""
    puts "   |   |   "  
  ...
  def play_again?
    ...
    loop do
      ...
      puts "Invalid response. Enter only y or n"
    end
